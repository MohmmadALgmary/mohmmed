...
function myFunction() {
    ...
    document.getElementById("bu_show_new_search").innerHTML = "";
    
    
    } else {
        x.style.display = "none";
            document.getElementById("bu_show").innerHTML = "اظهار خيارات البحث";
    document.getElementById("bu_show_new_search").innerHTML = "<button type='submit' onclick='fun_more()' class='myButton'> >>>> ابحث <<<< </button> ::: <button onclick='myFunction()' class='myButton3'> خيارات متقدمة.. </button>";        
    }
}
...
function search_main_ck(typ) {
var value = typ;
// alert("<input type='hidden' name='type_need_fild' value='"+value+"'>");
//    return false;
document.getElementById("type_need").innerHTML = "<input type='hidden' name='type_need_fild' value='"+value+"'>";

var x = document.forms["search_main"]["f_date"].value;
var y = document.forms["search_main"]["l_date"].value;   
if (x == "") {
alert("يجب اختيار تاريخ الوصول");

document.forms["search_main"]["f_date"].focus();
return false;
}
if (y == "") {
document.forms["search_main"]["l_date"].focus();
alert("يجب اختيار تاريخ المغادرة");
return false;
}  


document.getElementById("search_main").submit();
}
function fun_more1() {
var r1 = document.getElementById("fromDate").value;
var r2 = document.getElementById("toDate").value;
if (r1 != "" && r2 != "") {
document.getElementById("fun_more_button").innerHTML = "جاري البحث...";
}
}
...
function fun_more() {
    /*------------------ edited by HObs------------------- */
document.getElementById("type_need").innerHTML = "<input type='hidden' name='type_need_fild' value=''";
var r1 = document.getElementById("fromDate").value;
var r2 = document.getElementById("toDate").value;
if (r1 != "" && r2 != "") {
document.getElementById("fun_more_button").innerHTML = "جاري البحث...";
document.getElementById("fun_more_button1").innerHTML = "جاري البحث...";
}
/*
var x = document.forms["search_main"]["f_date"].value;
var y = document.forms["search_main"]["l_date"].value;   
if (x == "") {
alert("يجب اختيار تاريخ الدخول");
return false;
}
if (y == "") {
alert("يجب اختيار تاريخ المغادرة");
